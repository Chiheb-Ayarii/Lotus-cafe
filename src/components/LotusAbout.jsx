    ...
    <div className="lotus-about">
      ...
      <section className="intro-section lotusabout" ref={addToRefs}>
        <div className="section-container">
          ...
          <div className="intro-image">
            <img src="/lotus-coffee-latte-art.jpg" alt="Lotus Coffee" />
          </div>
        </div>
      </section>
      ...
      <section className="distinction-section lotusabout" ref={addToRefs}>
        <div className="section-container">
          ...
          <div className="section-image">
            <img src="/lotus-interior-garden.jpg" alt="Lotus Interior Garden" />
          </div>
        </div>
      </section>
      ...
      <section className="elegance-section lotusabout" ref={addToRefs}>
        <div className="section-container reverse">
          ...
          <div className="section-image">
            <img src="/lotus-terrace-view.jpg" alt="Lotus Terrace" />
          </div>
        </div>
      </section>
      ...
      <section className="excellence-section lotusabout" ref={addToRefs}>
        <div className="section-container">
          ...
          <div className="section-image">
            <img src="/lotus-interior-night.jpg" alt="Lotus Interior Night" />
          </div>
        </div>
      </section>
